...
export default function HomePage() {
  return (
    <main className="relative min-h-screen flex flex-col items-center justify-start bg-background text-white px-4 sm:px-6 overflow-hidden">
      ...
      <section className="z-10 text-center max-w-3xl sm:max-w-4xl lg:max-w-5xl mt-4 px-2">
        <h1 className="text-2xl sm:text-4xl md:text-6xl font-bold mb-6 leading-tight tracking-tight text-center whitespace-nowrap overflow-hidden">
        ...
        <Link href="/agents">
          <Button className="px-6 py-5 text-base sm:text-lg font-medium rounded-2xl bg-gradient-to-r from-blue-600 to-purple-600 text-white shadow-lg hover:scale-105 transition-transform duration-300">
            🚀 Create Your Agent
          </Button>
        </Link>
      </section>
